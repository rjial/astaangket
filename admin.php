...
if (isset($_POST['cari_nama_siswa']) && $_POST['cari_nama_siswa'] == "") {
  unset($_POST['cari_nama_siswa']);
}
if (isset($_POST['cari_nis_siswa']) && $_POST['cari_nis_siswa'] == "") {
  unset($_POST['cari_nis_siswa']);
}
if (isset($_POST['submit_cari_siswa'])) {
  $_SESSION['ayeee'] = "ayeeee";
                     ...
                     if ($_POST['cek_sudah'] == "on") {
                       while ($siswa = mysqli_fetch_assoc($query)) {
                         ...
                         while ($mamamatpel = mysqli_fetch_assoc($cecek_matpel)) {
                           $mmamatpel = $mamamatpel['matpel'];
                           $cecek_guru = mysqli_query($connectdb, "SELECT * FROM guru2 WHERE matpel='$mmamatpel'");
                           while ($guguguguru = mysqli_fetch_assoc($cecek_guru)) {
                             $ggguguru = $guguguguru['id'];
                             $cecek_hasil = mysqli_query($connectdb, "SELECT * FROM hasil WHERE id_guru='$ggguguru'");
                             while ($hahahasil = mysqli_fetch_assoc($cecek_hasil)) {
                               $sudah = 0;
                               $belum = 0;

                               if ($id_sudah_dicek != $hahahasil['id_siswa']) {
